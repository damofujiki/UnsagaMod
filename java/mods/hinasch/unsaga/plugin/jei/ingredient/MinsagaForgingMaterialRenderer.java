...
public class MinsagaForgingMaterialRenderer implements IIngredientRenderer<MinsagaForging.Material>{


	@Override
	public void render(Minecraft minecraft, int xPosition, int yPosition, Material ingredient) {
...
//		}
	...
	@Override
	public List<String> getTooltip(Minecraft minecraft, Material ingredient) {
	...
	@Override
	public FontRenderer getFontRenderer(Minecraft minecraft, Material ingredient) {
		// TODO 自動生成されたメソッド・スタブ
