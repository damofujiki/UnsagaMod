...
//		this.weight = weight;
	...
	public UnsagaMaterial(String res, String name) {
		super(new ResourceLocation(res), name);
//		this.weight = weight;
		// TODO 自動生成されたコンストラクター・スタブ
	}
...
//		}
	...
	public void setShieldPower(int p){
		this.shieldPower = p;
	}
	...
	public Optional<UnsagaMaterials.Category> getParent(){
	 ...
	 * @param c
	 */
	protected void setParent(UnsagaMaterials.Category c){
...
//				}
	...
	@Override
	public void applyJson(UnsagaMaterials.JsonParserMaterial parser) {
