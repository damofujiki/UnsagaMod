...
//
//					((EntityPlayer)entityplayer).inventory.clearMatchingItems(UnsagaMod.items.ammo,-1,1,null);
//				}
...
//		if(ep.inventory.hasItemStack(new ItemStack(UnsagaMod.items.ammo))) return true;
//		return false;
//	}
//
//	@Override
...
//			// TODO 自動生成されたメソッド・スタブ
//			return input.getItem() instanceof ItemGunUnsaga;
//		}
//	};
