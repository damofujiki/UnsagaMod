package mods.hinasch.unsaga.core.item.icon;
...
public class ComponentSelectableIcon {
	...
	public static Predicate<AttachCapabilitiesEvent.Item> predicate = input -> input.getItem() instanceof IIconItem;
	...
	public static CapabilityAdapterFrame<INegaPosi> adapterBase = UnsagaMod.capabilityFactory.create(capabilityAdapter);
	public static ComponentCapabilityAdapterItem<INegaPosi> adapter = (ComponentCapabilityAdapterItem<INegaPosi>) adapterBase.createChildItem("iconItem")
