...
public class EntityFireArrow extends EntityThrowableBase{
	...
	public void onUpdate(){
		...
		if(this.ticksExisted %2 ==0){
			ParticleHelper.MovingType.FLOATING.spawnParticle(worldObj, XYZPos.createFrom(this), EnumParticleTypes.FLAME, this.worldObj.rand, 10, 0.03D);
		}
	...
	public DamageSource getDamageSource(RayTraceResult result) {
		...
		return DamageSourceUnsaga.createProjectile(this.getThrower(), this, this.getDamage(), General.MAGIC).setSubTypes(Sub.FIRE).setStrLPHurt(SpellRegistry.instance().fireArrow.getEffectStrength().lp());
	}
