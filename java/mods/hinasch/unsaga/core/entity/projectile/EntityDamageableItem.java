...
public class EntityDamageableItem extends EntityItem{
    ...
    public void onUpdate()
    {
    	...
    	if(this.worldObj.rand.nextInt(5)==0){
    		ClientHelper.spawnParticle(worldObj, EnumParticleTypes.VILLAGER_HAPPY, XYZPos.createFrom(this)	, new XYZPos(0,0.01D,0));
    	}
    	List<EntityLivingBase> entities = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox(),input -> input!=getShooter());
    	...
    	if(this.onGround){
    		EntityItem entityItem = new EntityItem(this.worldObj,posX,posY,posZ,this.getEntityItem());
