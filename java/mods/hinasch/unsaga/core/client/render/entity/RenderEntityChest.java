...
public class RenderEntityChest extends RenderLiving<EntityUnsagaChestNew>{
...
//	private ModelChest modelChest = new ModelChest();
	...
	public RenderEntityChest(RenderManager rm){
		super(rm, new ModelChestCustom(), 1.0F);
	}

	@Override
	protected ResourceLocation getEntityTexture(EntityUnsagaChestNew p_110775_1_) {
	...
	@Override
	public void doRender(EntityUnsagaChestNew e, double d1,
