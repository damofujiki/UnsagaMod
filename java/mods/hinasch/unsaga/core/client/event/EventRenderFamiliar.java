...
import mods.hinasch.unsaga.core.potion.ShieldProperty;
...
public class EventRenderFamiliar {
	...
	public void onRenderLiving(RenderLivingEvent.Post e){
		...
		ShieldProperty.shields.stream().forEach(in ->{
