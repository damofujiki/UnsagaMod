...
import mods.hinasch.unsaga.villager.smith.ForgedItemFactory;
import mods.hinasch.unsaga.villager.smith.ForgedItemFactory.ForgeResult;
...
//	protected DebugUnsaga debug;
	...
	public ContainerSmithUnsaga(final IMerchant par1,World par2,EntityPlayer ep){
...
//		}
		...
		this.factory = new ForgedItemFactory(this.worldobj.rand,this);
//		//server only
...
//				UnsagaMod.logger.trace("zzz", SuitableLists.getSuitableList(cate).values());
				if(SuitableLists.getSuitableList(cate).contain(mate)){
