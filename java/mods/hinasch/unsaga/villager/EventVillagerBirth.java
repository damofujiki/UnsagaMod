...
public class EventVillagerBirth {
	...
	public void onBirth(BabyEntitySpawnEvent e){
		...
		if(e.getChild() instanceof EntityVillager && UnsagaMod.configHandler.isEnableHighProbBirthUnsagaVillagers()){
	...
	public void onEntityConstruct(LivingUpdateEvent e){
		if(!UnsagaMod.configHandler.isForceVillagerToChangeProfession()){
			return;
		}
