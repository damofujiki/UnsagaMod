...
public class ConnectedBlocksBreaker extends AbstractConnectScanner{

	protected int breaked;

	public ConnectedBlocksBreaker(World world,int length,Set<IBlockState> compareBlock, BlockPos startpoint,EntityLivingBase sender) {
