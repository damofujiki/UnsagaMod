...
//			Unsaga.debug("範囲内に発見");
			...
			for(EntityLivingBase living:livings){
				DamageSourceUnsaga ds = DamageSourceUnsaga.create(this.owner,spells.thunderCrap.getEffectStrength().lp(),General.MAGIC);
				ds.setSubTypes(Sub.ELECTRIC);
//				ds.setElement(FiveElements.Type.WOOD);
				living.attackEntityFrom(ds, spells.thunderCrap.getEffectStrength().hp());
			}
