...
import mods.hinasch.unsaga.util.UnsagaVillager.IUnsagaVillager.VillagerType;
...
public class UnsagaVillager {
	...
	public static class DefaultImpl implements IUnsagaVillager{
		...
		protected ItemStack[] merchantInvSecret = new ItemStack[3];
		...
		@Override
		public ItemStack[] getMerchandises() {
			// TODO 自動生成されたメソッド・スタブ
		...
		public ItemStack getSecretMerchandise(int par1) {
			// TODO 自動生成されたメソッド・スタブ
			return this.merchantInvSecret[par1];
		}

		@Override
		public ItemStack[] getSecretMerchandises() {
			// TODO 自動生成されたメソッド・スタブ
		...
		public void setMerchandise(int slot, ItemStack is) {
			// TODO 自動生成されたメソッド・スタブ
			this.merchantInventory[slot] = is;
		}

		@Override
		public void setMerchandises(List<ItemStack> stacks) {
		...
		public void setSecretMerchandise(int slot, ItemStack is) {
			...
			this.merchantInvSecret[slot] = is;
		}

		@Override
		public void setSecretMerchandises(List<ItemStack> stacks) {
	...
	public static class Storage extends  CapabilityStorage<IUnsagaVillager>{
		...
		public void readNBT(NBTTagCompound comp, Capability<IUnsagaVillager> capability, IUnsagaVillager instance,
			...
			if(instance.getType()==VillagerType.BARTERING){
				...
				instance.setMerchandises(Lists.newArrayList(UtilNBT.getItemStacksFromNBT(tagMerchandise, instance.getMerchandises().length)));
				instance.setSecretMerchandises(Lists.newArrayList(UtilNBT.getItemStacksFromNBT(tagSecret, instance.getSecretMerchandises().length)));
	...
	public static CapabilityAdapterFrame<IUnsagaVillager> base = UnsagaMod.capabilityFactory.create(ica);


	public static ComponentCapabilityAdapterEntity<IUnsagaVillager> adapter = base.createChildEntity("villager");


	static{
		adapter.setPredicate(ev -> ev.getEntity() instanceof EntityVillager);
